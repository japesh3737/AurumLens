...
export const CursorGrid: React.FC<CursorGridProps> = ({
  ...
  useEffect(() => {
    ...
    const targetEl = interactive ? container : window;
  ...
  }, [cellSize, interactive, clickPulse]);
  ...
  return (
    <div ref={containerRef} className={`cursor-grid ${interactive ? 'interactive' : ''} ${className}`.trim()}>
